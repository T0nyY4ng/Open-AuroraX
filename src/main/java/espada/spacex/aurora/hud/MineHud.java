...
public class MineHud extends HudElement {
   ...
   public static final HudElementInfo<MineHud> INFO;
   ...
   public MineHud() {
      ...
      this.shown = this.sgShown.add(((EnumSetting.Builder)((EnumSetting.Builder)((EnumSetting.Builder)((EnumSetting.Builder)(new EnumSetting.Builder()).name("shown")).description("When this text element is shown.")).defaultValue(MineHud.Shown.Always)).onChanged((s) -> this.recompile())).build());
      this.condition = this.sgShown.add(((StringSetting.Builder)((StringSetting.Builder)((StringSetting.Builder)((StringSetting.Builder)((StringSetting.Builder)(new StringSetting.Builder()).name("condition")).description("Condition to check when shown is not Always.")).visible(() -> this.shown.get() != MineHud.Shown.Always)).defaultValue("")).onChanged((s) -> this.recompile())).renderer(StarscriptTextBoxRenderer.class).build());
   ...
   private void runTick(HudRenderer renderer) {
      if (this.needsCompile) {
         ...
         if (this.shown.get() != MineHud.Shown.Always) {
      ...
      if (this.shown.get() != MineHud.Shown.Always && this.conditionScript != null) {
         String text = MeteorStarscript.run(this.conditionScript);
         if (text == null) {
            this.visible = false;
         } else {
            this.visible = this.shown.get() == MineHud.Shown.WhenTrue ? text.equalsIgnoreCase("true") : text.equalsIgnoreCase("false");
         }
      }
   ...
   public void render(HudRenderer renderer) {
      ...
      boolean visible = this.shown.get() == MineHud.Shown.Always || this.visible;
   ...
   static {
      INFO = new HudElementInfo(Aurora.HUD_EDIT, "MineHud", "Welcomes you.", MineHud::new);
   }

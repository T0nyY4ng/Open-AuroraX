...
public class MaoJunQingAura extends Modules {
   ...
   private final Setting<MaoJunQingType.SwitchMode> switchMode;
   private final Setting<MaoJunQingType.LogicMode> logicMode;
   ...
   private final Setting<MaoJunQingType.FadeMode> fadeMode;
   ...
   public MaoJunQingAura() {
      super(Aurora.CombatPlus, "MaoJunQing Aura", "Automatically destroys people using anchors.");
      ...
      this.switchMode = this.sgGeneral.add(((EnumSetting.Builder)((EnumSetting.Builder)((EnumSetting.Builder)(new EnumSetting.Builder()).name("Switch Mode")).description("Switching method. Silent is the most reliable but doesn't work everywhere.")).defaultValue(MaoJunQingType.SwitchMode.Silent)).build());
      this.logicMode = this.sgGeneral.add(((EnumSetting.Builder)((EnumSetting.Builder)((EnumSetting.Builder)(new EnumSetting.Builder()).name("Logic Mode")).description("Logic for bullying kids.")).defaultValue(MaoJunQingType.LogicMode.BreakPlace)).build());
      ...
      this.fadeMode = this.sgRender.add(((EnumSetting.Builder)((EnumSetting.Builder)((EnumSetting.Builder)(new EnumSetting.Builder()).name("Fade Mode")).description("How long the fading should take.")).defaultValue(MaoJunQingType.FadeMode.Normal)).build());
   ...
   private void onRender(Render3DEvent event) {
      ...
      if (this.tickTime >= 0L && this.mc.player != null && this.mc.world != null) {
         ...
         if (this.renderPos != null) {
            ...
            if (r >= 0.001 && this.fadeMode.get() != MaoJunQingType.FadeMode.Test2) {
               double down = (double)-0.5F;
               double up = (double)-0.5F;
               double width = (double)0.5F;
               int a = 0;
               switch ((MaoJunQingType.FadeMode)this.fadeMode.get()) {
                  case Up:
                     up = (double)0.0F;
                     down = -(r * (double)2.0F);
                     break;
   ...
   private void update() {
      if (this.placePos != null && this.placeData != null && this.placeData.valid()) {
         ...
         Object var10000 = this.logicMode.get();
         MaoJunQingType.LogicMode var10001 = this.LogicMode;
         if (var10000 == MaoJunQingType.LogicMode.PlaceBreak) {
            switch (anchor.state) {
               case Anchor:
                  if (this.chargeUpdate(this.placePos)) {
                     MaoJunQingType.AnchorState var10002 = this.AnchorState;
                     Anchor a = new Anchor(MaoJunQingType.AnchorState.Loaded, anchor.charges + 1, System.currentTimeMillis());
               ...
               case Loaded:
                  if (this.explodeUpdate(this.placePos)) {
                     this.anchors.remove(this.placePos);
                     MaoJunQingType.AnchorState var5 = this.AnchorState;
                     this.anchors.put(this.placePos, new Anchor(MaoJunQingType.AnchorState.Air, 0, System.currentTimeMillis()));
                  }
                  break;
               case Air:
                  ...
                  if (this.placeUpdate()) {
                     this.anchors.remove(this.placePos);
                     MaoJunQingType.AnchorState var10004 = this.AnchorState;
                     this.anchors.put(this.placePos, new Anchor(MaoJunQingType.AnchorState.Anchor, 0, System.currentTimeMillis()));
                     this.timer = (double)0.0F;
                  }
            }
         } else {
            switch (anchor.state) {
               case Anchor:
                  if (this.chargeUpdate(this.placePos)) {
                     MaoJunQingType.AnchorState var4 = this.AnchorState;
                     Anchor a = new Anchor(MaoJunQingType.AnchorState.Loaded, anchor.charges + 1, System.currentTimeMillis());
                     this.anchors.remove(this.placePos);
                     this.anchors.put(this.placePos, a);
                  }
               ...
               case Loaded:
                  ...
                  if (this.explodeUpdate(this.placePos)) {
                     this.anchors.remove(this.placePos);
                     MaoJunQingType.AnchorState var7 = this.AnchorState;
                     this.anchors.put(this.placePos, new Anchor(MaoJunQingType.AnchorState.Air, 0, System.currentTimeMillis()));
                     this.timer = (double)0.0F;
                  }
                  break;
               case Air:
                  if (this.placeUpdate()) {
                     this.anchors.remove(this.placePos);
                     MaoJunQingType.AnchorState var6 = this.AnchorState;
                     this.anchors.put(this.placePos, new Anchor(MaoJunQingType.AnchorState.Anchor, 0, System.currentTimeMillis()));
                  }
            }
         }
   ...
   private Anchor getAnchor(BlockPos pos) {
      if (this.anchors.containsKey(pos)) {
         ...
         MaoJunQingType.AnchorState stateType;
         if (state.getBlock() == Blocks.RESPAWN_ANCHOR) {
            stateType = (Integer)state.get(Properties.CHARGES) < 1
               ? MaoJunQingType.AnchorState.Anchor
               : MaoJunQingType.AnchorState.Loaded;
         } else {
            stateType = MaoJunQingType.AnchorState.Air;
         }

         return new Anchor(stateType, state.getBlock() == Blocks.RESPAWN_ANCHOR ? (Integer)state.get(Properties.CHARGES) : 0, System.currentTimeMillis());
      }
   }
   ...
   private boolean placeUpdate() {
      ...
      if (!switched) {
         switch ((MaoJunQingType.SwitchMode)this.switchMode.get()) {
            case Silent:
            case Normal:
   ...
   private void interact(BlockPos pos, Direction dir, Hand hand) {
      ...
      Object var10000 = this.fadeMode.get();
      MaoJunQingType.FadeMode var10001 = this.FadeMode;
      if (var10000 == MaoJunQingType.FadeMode.Test2) {
   ...
   private static record Anchor(MaoJunQingType.AnchorState state, int charges, long time) {
   }

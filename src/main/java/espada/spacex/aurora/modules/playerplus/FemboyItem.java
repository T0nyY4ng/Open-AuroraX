...
public class FemboyItem extends Modules {
   ...
   public FemboyItem() {
      super(Aurora.PlayerPlus, "Femboy Item", "Automatically uses ender pearl or firework rocket without rotating.");
      this.sgGeneral = this.settings.getDefaultGroup();
      this.sgRender = this.settings.createGroup("Render");
      this.item = this.sgGeneral.add(((EnumSetting.Builder)((EnumSetting.Builder)((EnumSetting.Builder)(new EnumSetting.Builder()).name("Item")).description("The item to use (Ender Pearl or Firework Rocket).")).defaultValue(FemboyItem.UseItem.EnderPearl)).build());
      ...
      this.ccSwitchMode = this.sgGeneral.add(((EnumSetting.Builder)((EnumSetting.Builder)((EnumSetting.Builder)(new EnumSetting.Builder()).name("CC Switch Mode")).description("Switch method for CC bypass block.")).defaultValue(FemboyItem.SwitchMode.Silent)).build());
      this.switchMode = this.sgGeneral.add(((EnumSetting.Builder)((EnumSetting.Builder)((EnumSetting.Builder)(new EnumSetting.Builder()).name("Switch Mode")).description("Switch method for the item.")).defaultValue(FemboyItem.SwitchMode.Silent)).build());

...
public class ScaffoldPlus extends Modules {
   ...
   private final Setting<MotionMode> motionMode;
   private final Setting<Double> distanceAdjust;
   ...
   public ScaffoldPlus() {
      super(Aurora.PlayerPlus, "Scaffold+", "KasumsSoft blockwalk.");
      ...
      this.smart = this.sgGeneral.add(((BoolSetting.Builder)((BoolSetting.Builder)((BoolSetting.Builder)((BoolSetting.Builder)(new BoolSetting.Builder()).name("Smart")).description("Only places on blocks that you can reach.")).defaultValue(true)).visible(() -> this.scaffoldMode.get() == ScaffoldPlus.ScaffoldMode.Normal)).build());
      this.tower = this.sgGeneral.add(((BoolSetting.Builder)((BoolSetting.Builder)((BoolSetting.Builder)((BoolSetting.Builder)(new BoolSetting.Builder()).name("Tower")).description("Flies up with blocks.")).defaultValue(true)).visible(() -> this.scaffoldMode.get() == ScaffoldPlus.ScaffoldMode.Normal)).build());
      this.sSprint = this.sgGeneral.add(((BoolSetting.Builder)((BoolSetting.Builder)((BoolSetting.Builder)((BoolSetting.Builder)(new BoolSetting.Builder()).name("Stop Sprint")).description("Stops you from sprinting.")).defaultValue(true)).visible(() -> this.scaffoldMode.get() == ScaffoldPlus.ScaffoldMode.Normal)).build());
      this.safeWalk = this.sgGeneral.add(((BoolSetting.Builder)((BoolSetting.Builder)((BoolSetting.Builder)((BoolSetting.Builder)(new BoolSetting.Builder()).name("SafeWalk")).description("Should SafeWalk be used.")).defaultValue(true)).visible(() -> this.scaffoldMode.get() == ScaffoldPlus.ScaffoldMode.Normal)).build());
      this.useTimer = this.sgGeneral.add(((BoolSetting.Builder)((BoolSetting.Builder)((BoolSetting.Builder)((BoolSetting.Builder)(new BoolSetting.Builder()).name("Use timer")).description("Should we use timer.")).defaultValue(false)).visible(() -> this.scaffoldMode.get() == ScaffoldPlus.ScaffoldMode.Normal)).build());
      SettingGroup var10001 = this.sgGeneral;
      DoubleSetting.Builder var10002 = new DoubleSetting.Builder();
      Setting<Boolean> var10003 = this.useTimer;
      Objects.requireNonNull(var10003);
      this.timer = var10001.add(((DoubleSetting.Builder)((DoubleSetting.Builder)((DoubleSetting.Builder)((DoubleSetting.Builder)var10002.visible(var10003::get)).name("Timer")).description("Sends more packets.")).defaultValue(1.088).min((double)0.0F).sliderMax((double)10.0F).visible(() -> this.scaffoldMode.get() == ScaffoldPlus.ScaffoldMode.Normal && (Boolean)this.useTimer.get())).build());
      this.motionMode = this.sgGeneral.add(((EnumSetting.Builder)((EnumSetting.Builder)((EnumSetting.Builder)((EnumSetting.Builder)(new EnumSetting.Builder()).name("Motion Mode")).description("Adjusts the motion prediction speed.")).defaultValue(ScaffoldPlus.MotionMode.Normal)).visible(() -> this.scaffoldMode.get() == ScaffoldPlus.ScaffoldMode.Normal)).build());
      this.distanceAdjust = this.sgGeneral.add(((DoubleSetting.Builder)((DoubleSetting.Builder)((DoubleSetting.Builder)(new DoubleSetting.Builder()).name("Distance Adjustment")).description("Scales the motion distance for block placement prediction.")).defaultValue((double)1.0F).min((double)0.5F).max((double)2.0F).sliderRange((double)0.5F, (double)2.0F).visible(() -> this.scaffoldMode.get() == ScaffoldPlus.ScaffoldMode.Normal)).build());
      this.switchMode = this.sgPlacing.add(((EnumSetting.Builder)((EnumSetting.Builder)((EnumSetting.Builder)((EnumSetting.Builder)(new EnumSetting.Builder()).name("Switch Mode")).description("Method of switching. Silent is the most reliable.")).defaultValue(ScaffoldPlus.SwitchMode.Silent)).visible(() -> this.scaffoldMode.get() == ScaffoldPlus.ScaffoldMode.Normal)).build());
      this.blocks = this.sgPlacing.add(((BlockListSetting.Builder)((BlockListSetting.Builder)((BlockListSetting.Builder)(new BlockListSetting.Builder()).name("Blocks")).description("Blocks to use.")).defaultValue(new Block[]{Blocks.OBSIDIAN, Blocks.CRYING_OBSIDIAN, Blocks.NETHERITE_BLOCK}).visible(() -> this.scaffoldMode.get() == ScaffoldPlus.ScaffoldMode.Normal)).build());
      this.placeDelay = this.sgPlacing.add(((DoubleSetting.Builder)((DoubleSetting.Builder)((DoubleSetting.Builder)(new DoubleSetting.Builder()).name("Place Delay")).description("Delay between places.")).defaultValue((double)0.125F).range((double)0.0F, (double)10.0F).sliderRange((double)0.0F, (double)10.0F).visible(() -> this.scaffoldMode.get() == ScaffoldPlus.ScaffoldMode.Normal)).build());
      this.places = this.sgPlacing.add(((IntSetting.Builder)((IntSetting.Builder)((IntSetting.Builder)((IntSetting.Builder)(new IntSetting.Builder()).name("Places")).description("Blocks placed per place.")).defaultValue(1)).range(1, 10).sliderRange(1, 10).visible(() -> this.scaffoldMode.get() == ScaffoldPlus.ScaffoldMode.Normal)).build());
      this.cooldown = this.sgPlacing.add(((DoubleSetting.Builder)((DoubleSetting.Builder)((DoubleSetting.Builder)(new DoubleSetting.Builder()).name("Cooldown")).description("Delay between places at each spot.")).defaultValue(0.3).range((double)0.0F, (double)5.0F).sliderRange((double)0.0F, (double)5.0F).visible(() -> this.scaffoldMode.get() == ScaffoldPlus.ScaffoldMode.Normal)).build());
      this.extrapolation = this.sgPlacing.add(((IntSetting.Builder)((IntSetting.Builder)((IntSetting.Builder)((IntSetting.Builder)(new IntSetting.Builder()).name("Extrapolation")).description("Predicts movement.")).defaultValue(3)).range(1, 20).sliderRange(0, 20).visible(() -> this.scaffoldMode.get() == ScaffoldPlus.ScaffoldMode.Normal)).build());
   ...
   private List<BlockPos> getBlocks() {
      ...
      double motionScale;
      switch (((MotionMode)this.motionMode.get()).ordinal()) {
         case 1 -> motionScale = (double)1.5F;
         case 2 -> motionScale = (double)0.5F;
         default -> motionScale = (double)1.0F;
      }

      double adjustedMotionX = this.motion.x * motionScale * (Double)this.distanceAdjust.get();
      double adjustedMotionZ = this.motion.z * motionScale * (Double)this.distanceAdjust.get();

      for(int i = 0; i < (Integer)this.extrapolation.get() * 10; ++i) {
         vec = vec.add(adjustedMotionX / (double)10.0F, (double)0.0F, adjustedMotionZ / (double)10.0F);
   ...
   private Box getBox(Vec3d vec) {
      ...
      return new Box(vec.x - 0.1, vec.y, vec.z - 0.1, vec.x + 0.1, vec.y + (box.maxY - box.minY), vec.z + 0.1);
   }
   ...
   public static enum MotionMode {
      Normal,
      Fast,
      Slow;

      // $FF: synthetic method
      private static MotionMode[] $values() {
         return new MotionMode[]{Normal, Fast, Slow};
      }
   }
}
